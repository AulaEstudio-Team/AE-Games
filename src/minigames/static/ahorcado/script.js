...
function verificar(RANDOM, array, fallos){
    ...
    if(fallos==3){
        document.getElementById("imagen2").src='img/ahorcado_3.png';
    }
    if(fallos==4){
        document.getElementById("imagen2").src='img/ahorcado_2.png';
    }
    if(fallos==5){
        document.getElementById("imagen2").src='img/ahorcado_1.png';
    }
    if(fallos==6){
        document.getElementById("imagen2").src='img/ahorcado_1.png';
...
window.onload(mostrar_texto.innerHTML=array);