...
from .views import mock_minigame_view, conecta4, wordle_minigame, TRON_Legacy_minigame_view, ahorcado_view, my_guerradelperujuego, atari_breakout, pinturillas
